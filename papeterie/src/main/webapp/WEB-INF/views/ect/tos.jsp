...
<body>
<div id="section3">
	<div id="tos-head">이용약관</div>
	<div id="pre-text">
		<pre>제1조(목적)
이 약관은 주식회사 PAPETERIE(이하 “회사”라 한다)이 운영하는 PAPETERIE 쇼핑몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 “이용자”의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
